...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { artist_id: @release.artist_id, image: @release.image, link: @release.link, title: @release.title } }, as: :json
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { artist_id: @release.artist_id, image: @release.image, link: @release.link, title: @release.title } }, as: :json
    assert_response 200
  end
